...
| **Master catalog** (`master_catalog.py`) | `unload_master_catalog()` after bootstrap teardown; flock load + merge-on-save under concurrent writers (v1.9.10 unreleased — [#35](https://github.com/MarcoPorcellato/matryca-plumber/issues/35), [#36](https://github.com/MarcoPorcellato/matryca-plumber/issues/36)) |
